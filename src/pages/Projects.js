...
import { Hugus, RealTimeWork, Snapbit } from '@components';
  ...
  .container {
    ...
    .list {
      ...
      li {
        ...
        #snapbit {
          ${props =>
            props.type === 'snapbit' && 'color:#68b8f5;span{opacity:1}'};
        }

        /* #pickget {
          ${props =>
            props.type === 'pickget' && 'color:mediumpurple;span{opacity:1}'};
        } */
      }
    }
    ...
    .bar {
      ...
      #snapbit {
        opacity: ${props => (props.type === 'snapbit' ? '1' : '0')};
        background-color: #68b8f5;
      }

      /* #pickget {
        opacity: ${props => (props.type === 'pickget' ? '1' : '0')};
    ...
    <ProjectsStyle onWheel={wheelEvent} scroll={scroll} type={type}>
      <div className="container">
        <ul className="list">
          ...
          {/* <li>
            <button id="snapbit" onClick={() => setType('snapbit')}>
              S<span>napbit</span>
            </button>
          </li> */}
        </ul>
