...
const parse = (src, {
  ...
  if (resp.headers.get("Content-Type") !== "image/gif") throw Error(`Wrong content type: "${resp.headers.get("Content-Type")}"`);
